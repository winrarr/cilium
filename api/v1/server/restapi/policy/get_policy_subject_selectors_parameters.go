...
// GetPolicySubjectSelectorsParams contains all the bound params for the get policy subject selectors operation
...
func (o *GetPolicySubjectSelectorsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
  var res []error
